...
def load_sfnn_data(dataset):
    ...
    x_train_data = sfnn_encode(train_set[0][:num])
    x_test_data = sfnn_encode(test_set[0][:num])
    x_valid_data = sfnn_encode(valid_set[0][:num])

    test_set_x, test_set_y = shared_dataset((x_test_data,test_set[1][:num]))
    valid_set_x, valid_set_y = shared_dataset((x_valid_data,valid_set[1][:num]))
    train_set_x, train_set_y = shared_dataset((x_train_data,train_set[1][:num]))
...
def load_data(dataset):
    ...
    test_set_x, test_set_y = shared_dataset((test_set[0][:num],test_set[1][:num]))
    valid_set_x, valid_set_y = shared_dataset((valid_set[0][:num],valid_set[1][:num]))
...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=1000,
    ...
    datasets = load_sfnn_data(dataset)
    ...
    classifier = LogisticRegression(input=x, n_in=6000, n_out=10)
